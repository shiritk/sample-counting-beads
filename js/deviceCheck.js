...
var myDeviceSupport = {
	    ...
	    HTML5_audio_ogg: !!(document.createElement('audio').canPlayType) && document.createElement('audio').canPlayType('audio/ogg') != "",
...
// app mode 
var checkApp = {
    isPhoneGapAppMode: (window.device),
    isMetroMode: (typeof WinJS !== "undefined") 
};
